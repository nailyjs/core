...
import type { NodePluginProtocol } from './plugin-protocol'
import { BackendBootstrap, HandlerContext, RestControllerSymbol } from '@nailyjs/backend'
...
export class NodeBootstrap extends BackendBootstrap<NodeHttpAdapter> {
  ...
  use(plugin: NodePluginProtocol | NodePluginProtocol[]): Promise<this> {
