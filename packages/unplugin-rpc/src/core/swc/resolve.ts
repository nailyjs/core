...
async function resolveFile(resolved: string, index = false): Promise<string | undefined> {
...
export async function resolveId(importee: string, importer?: string): Promise<string | undefined> {
